...
public class ParseFeed {
	...
	public static HashMap<String, String> loadEducationExpendFromCSV(PApplet p, String fileName) {
		// HashMap key: country ID and  data: lifeExp at birth
		HashMap<String, String> eduExpendMap = new HashMap<String, String>();
		...
		for (int i=1;i<rows.length;i++) {
			...
			for (int j=0;j<columns.length;j++){
				if (!columns[4].equals("")){
					eduExpendMap.put(columns[3], columns[4]);
				}
			}
		}
		return eduExpendMap;
